...
PUB_TOPICS = [
              ...
              TopicConfig('camera_floor_left/depth/parameter_descriptions', ConfigDescription),
              TopicConfig('camera_floor_left/depth/parameter_updates', Config),
              TopicConfig('camera_floor_left/depth/points', PointCloud2),
              ...
              TopicConfig('camera_floor_right/depth/parameter_descriptions', ConfigDescription),
              TopicConfig('camera_floor_right/depth/parameter_updates', Config),
              TopicConfig('camera_floor_right/depth/points', PointCloud2),
